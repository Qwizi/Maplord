...
# Always allow localhost for Docker healthcheck (port not exposed externally)
...
UNFOLD = {
    ...
    "STYLES": [
        lambda request: __import__("django.templatetags.static", fromlist=["static"]).static(
            "admin/css/unfold-custom.css"
        ),
    ],
    "COLORS": {
        "primary": {
