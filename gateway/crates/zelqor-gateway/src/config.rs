    ...
    pub fn from_env() -> Self {
        Self {
            ...
            livekit_api_secret: std::env::var("LIVEKIT_API_SECRET")
                .unwrap_or_else(|_| "devsecret-zelqor-at-least-32-chars-long".into()),
...
mod tests {
    ...
    mod from_env_overrides {
        ...
        fn cors_allowed_origins_splits_on_comma() {
            ...
            std::env::set_var(
                "CORS_ALLOWED_ORIGINS",
                "https://app.zelqor.com,https://staging.zelqor.com",
            );
            let cfg = AppConfig::from_env();
            std::env::remove_var("CORS_ALLOWED_ORIGINS");
            assert!(cfg.allowed_ws_origins.contains(&"https://app.zelqor.com".to_string()));
            assert!(cfg.allowed_ws_origins.contains(&"https://staging.zelqor.com".to_string()));
        }
        ...
        fn cors_allowed_origins_trims_whitespace() {
            ...
            assert!(cfg
                .allowed_ws_origins
                .contains(&"https://app.zelqor.com".to_string()));
        }
        ...
        fn cors_allowed_origins_filters_empty_entries() {
            ...
            std::env::set_var("CORS_ALLOWED_ORIGINS", ",https://app.zelqor.com,");
            let cfg = AppConfig::from_env();
            std::env::remove_var("CORS_ALLOWED_ORIGINS");
            assert!(cfg.allowed_ws_origins.contains(&"https://app.zelqor.com".to_string()));
