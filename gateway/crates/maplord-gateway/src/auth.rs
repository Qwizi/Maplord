...
mod tests {
    ...
    mod check_origin {
        ...
        fn allows_matching_origin() {
            let headers = headers_with_origin("https://app.maplord.com");
            let allowed = vec!["https://app.maplord.com".to_string()];
        ...
        fn allows_one_of_multiple_origins() {
            let headers = headers_with_origin("https://staging.maplord.com");
            let allowed = vec![
                "https://app.maplord.com".to_string(),
                "https://staging.maplord.com".to_string(),
            ];
        ...
        fn rejects_partial_origin_match() {
            ...
            let headers = headers_with_origin("https://app.maplord.com.evil.com");
            let allowed = vec!["https://app.maplord.com".to_string()];
        ...
        fn rejects_wrong_scheme() {
            let headers = headers_with_origin("http://app.maplord.com");
            let allowed = vec!["https://app.maplord.com".to_string()];
