    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, unique=True)),
                ('description', models.TextField(blank=True)),
                ('country_codes', models.JSONField(blank=True, default=list, help_text='List of ISO country codes to include. Empty = all countries.')),
                ('is_active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movement_type', models.CharField(choices=[('land', 'Land'), ('sea', 'Sea'), ('air', 'Air')], default='land', max_length=10)),
                ('is_active', models.BooleanField(default=True)),
                ('order', models.PositiveIntegerField(default=0)),
                ('produced_by', models.ForeignKey(blank=True, help_text='Building required to produce this unit (null=default unit)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='unit_types', to='game_config.buildingtype')),
            ],
            options={
                'ordering': ['order', 'name'],
            },
