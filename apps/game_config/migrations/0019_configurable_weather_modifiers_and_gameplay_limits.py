...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.FloatField(default=1.4, help_text='Combat randomness multiplier during storms (e.g. 1.4 = +40%)'),
        ),
        migrations.AddField(
            model_name='gamesettings',
            name='fog_randomness_modifier',
            field=models.FloatField(default=1.25, help_text='Combat randomness multiplier during fog (e.g. 1.25 = +25%)'),
        ),
        migrations.AddField(
            model_name='gamesettings',
            name='rain_randomness_modifier',
            field=models.FloatField(default=1.1, help_text='Combat randomness multiplier during rain (e.g. 1.1 = +10%)'),
        ),
        migrations.AddField(
            model_name='gamesettings',
            name='storm_energy_modifier',
            field=models.FloatField(default=0.85, help_text='Energy generation multiplier during storms (e.g. 0.85 = -15%)'),
        ),
        migrations.AddField(
            model_name='gamesettings',
            name='rain_energy_modifier',
            field=models.FloatField(default=0.95, help_text='Energy generation multiplier during rain (e.g. 0.95 = -5%)'),
        ),
        migrations.AddField(
            model_name='gamesettings',
            name='storm_unit_gen_modifier',
            field=models.FloatField(default=0.90, help_text='Unit generation multiplier during storms (e.g. 0.90 = -10%)'),
        ),
        migrations.AddField(
            model_name='gamesettings',
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(default=180, help_text='Seconds before disconnected player is eliminated'),
        ),
        migrations.AddField(
            model_name='gamesettings',
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(default=4, help_text='Max simultaneous unit production orders per region'),
        ),
        migrations.AddField(
            model_name='gamesettings',
