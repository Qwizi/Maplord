...
class GameAsset(models.Model):
    ...
    key = models.SlugField(max_length=150, unique=True, help_text='Unique key to reference this asset (e.g. matches asset_key in game config)')
    ...
    IMAGE_CATEGORIES = {AssetCategory.BUILDING, AssetCategory.UNIT, AssetCategory.ABILITY, AssetCategory.ICON, AssetCategory.TEXTURE}
