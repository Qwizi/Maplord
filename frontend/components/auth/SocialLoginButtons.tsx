...
import { getSocialAuthURL } from "@/lib/api";
    ...
    <div className="space-y-3">
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-background px-2 text-muted-foreground md:bg-card/80">
            lub kontynuuj przez
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          ...
          className="h-12 md:h-14 gap-2 rounded-xl md:rounded-xl text-sm md:text-base"
        >
